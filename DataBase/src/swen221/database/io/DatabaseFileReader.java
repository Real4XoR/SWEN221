...
import swen221.database.lang.ColumnType;
import swen221.database.lang.Database;
import swen221.database.lang.DuplicateKeyException;
import swen221.database.lang.InvalidRowException;
import swen221.database.lang.RowType;
import swen221.database.lang.DatabaseImpl;
...
public class DatabaseFileReader {
	...
	public Database read() throws InvalidRowException, DuplicateKeyException {		
		...
		//Initiate new databaseImpl object using existing fields
	...
	private int findKeyField(String schemaLine) throws DuplicateKeyException, InvalidRowException {
		//FIX ME: you need to implement this
		String[] columns = schemaLine.split(",");
		int keyField = -1;
		for (int i = 0; i < columns.length; i++) {
