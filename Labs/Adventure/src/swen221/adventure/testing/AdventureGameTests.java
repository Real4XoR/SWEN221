...
package swen221.adventure.testing;

import static org.junit.jupiter.api.Assertions.*;
import org.junit.jupiter.api.Test;

import swen221.adventure.AdventureGame;
import swen221.adventure.model.*;
import swen221.adventure.model.Room.Location;
...
public class AdventureGameTests {
	...
	public void test_03_PickupBook() {
		...
		Player p = game.getPlayer();
		Room r = p.getLocation();
		Item i = r.getItem(Location.NORTHWEST);
	...
	public void test_08_UnlockDoorFails() {
		...
		Player p = game.getPlayer();
		Room r = p.getLocation();
		Item key = r.getItem(Location.NORTHWEST);
		Item door = r.getItem(Location.NORTH);
	...
	public void test_11_SecretButtonFails() {
		...
		Player p = game.getPlayer();
		Room r = p.getLocation();
		Item button = r.getItem(Location.NORTHWEST);
		Item door = r.getItem(Location.NORTH);
